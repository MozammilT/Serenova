...
function Sidebar() {
  const sideBarLinks = [
    { name: "Dashboard", path: "/owner", icon: "dashboardIcon.svg" },
    { name: "Add Room", path: "/owner/add-room", icon: "addIcon.svg" },
    { name: "List Room", path: "/owner/list-room", icon: "listIcon.svg" },
  ];
